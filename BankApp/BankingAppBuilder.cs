...
{
    public static readonly Color32 PROGRESSBAR_BG = new(31, 41, 55, 255);
    public static readonly Color32 PROGRESSBAR_FILL = new(8, 145, 178, 255);
    public static readonly Color32 ONLINEBAL = new(34, 211, 238, 255);
    public static readonly Color32 CASHBAL = new(52, 211, 153, 255);
    public static readonly Color32 TABBUTTON_ACTIVE = new(8, 145, 178, 255);
    public static readonly Color32 TABBUTTON_ACTIVE_HOVER = new(14, 116, 144, 255);
    public static readonly Color32 TABBUTTON_DISABLED = new(31, 41, 55, 255);
    public static readonly Color32 TABBUTTON_DISABLED_HOVER = new(55, 65, 81, 255);
    public static readonly Color32 AMOUNTBUTTONS_DEFAULT = new(31, 41, 55, 255);
    public static readonly Color32 AMOUNTBUTTONS_HOVER = new(55, 65, 81, 255);
    public static readonly Color32 AMOUNTBUTTONS_CLICKED = new(20, 24, 29, 255);
    public static readonly Color32 CONFIRMBUTTON_DEFAULT = new(5, 150, 105, 255);
    public static readonly Color32 CONFIRMBUTTON_HOVERED = new(4, 120, 87, 255);
}
...
public class BankingAppBuilder
{
    ...
    public void BuildUI()
    {
        ...
        var roundedEdgeSprite = GetGameSprite("Rectangle_RoundedEdges") ?? defaultSprite;
        var buttonSprite = roundedEdgeSprite;
        ...
        var initRatio = Mathf.Clamp01(ATM.WeeklyDepositSum / ATM.WEEKLY_DEPOSIT_LIMIT);
        ...
        var onlineBalanceLabel =
            CreateText("OnlineLabel", onlineBalanceGO.transform, 20, new Color32(139, 145, 155, 255));
